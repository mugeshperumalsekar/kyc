            ...
            <div id="pdfContent">
                        ...
                        {directors.map((director, directorIndex) => (
                            <div key={directorIndex} className="person-container">
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={3}>
                                        <p style={headingStyle}><strong>Nationality  :</strong> {nationalityMap[director.nationality] || 'Not Available'}</p>
                                    </Grid>
                                    <Grid item xs={3}>
                        ...
                        {shareHolders.map((shareHolder, shareHolderIndex) => (
                            <div key={shareHolderIndex} className="person-container">
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={3}>
                                        <p style={headingStyle}><strong>Nationality  :</strong> {nationalityMap[shareHolder.nationality] || 'Not Available'}</p>
                                    </Grid>
                                    <Grid item xs={3}>
                ...
                {signAuthority.map((authority, signAuthorityIndex) => (
                    <div key={signAuthorityIndex}>
                        ...
                        <Typography variant="body1" paragraph align="right">
                            <TextField name="authorizeName" size='small' variant="standard" value={authority.name} autoComplete='off' inputProps={{ readOnly: true }} placeholder='Name' multiline minRows={1} maxRows={4} />
                        </Typography>
                        <Typography variant="body1" paragraph align="right">
                            <TextField name="authorizeDesignation" size='small' variant="standard" value={authority.designation} autoComplete='off' inputProps={{ readOnly: true }} placeholder='Designation' multiline minRows={1} maxRows={4} />
                        </Typography>
                        <Typography variant="body1" paragraph align="right">
                            (Name & Designation)
                        </Typography>
