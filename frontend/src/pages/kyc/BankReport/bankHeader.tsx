                        ...
                        <Paper style={{ marginBottom: '20px' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <div>
                                    ...
                                    <Typography variant="body1" paragraph align="right">
                                        <TextField name="authorizeName" size='small' variant="standard" value={declarationFrom.authorizeName} autoComplete='off' multiline minRows={1} maxRows={4} />
                                    </Typography>
                                    <Typography variant="body1" paragraph align="right">
                                        <TextField name="authorizeDesignation" size='small' variant="standard" value={declarationFrom.authorizeDesignation} autoComplete='off' multiline minRows={1} maxRows={4} />
                                    </Typography>
                                    <Typography variant="body1" paragraph align="right">
                                        (Name & Designation)
                                    </Typography>
