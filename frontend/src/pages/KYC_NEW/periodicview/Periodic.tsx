...
const Periodic = () => {
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            {/* <label htmlFor={`${label.toLowerCase()}-file-input`}>
                <IconButton component="span" sx={{ backgroundColor: '#1976d2', color: '#fff', '&:hover': { backgroundColor: '#115293' } }}>
                    <CloudUploadIcon sx={{ color: isFileUploaded ? 'yellowgreen' : '#fff' }} />
                </IconButton>
            </label> */}
    ...
    const calculateAverageScores = () => {
        ...
        console.log('SelectedPep:', selectedPep);
        console.log('SelectedNegative:', selectedNegative);
        ...
        if (selectedPep && selectedNegative && selectedEntity) {
            ...
            console.log('AveragePep:', averagePep);
            console.log('AverageNegative:', averageNegative);
            console.log('AverageEntity:', averageEntity);
    ...
    const handleSaveButtonClick = async () => {
        // if (!selectedPepScore && !selectedNegativeScore && !selectedEntityScore && !pepFiles && !negativeFiles && !entityFiles) {
