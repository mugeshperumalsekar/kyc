...
import '../../../pages/BankReport/pep/PepReport.css';
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                    <Card border='10px' style={{ boxShadow: '1px 1px 1px grey', width: '96%', marginLeft: '2%', marginTop: '6%' }}>
                        <h5 style={{ textAlign: 'center', marginTop: '2%' }}>BANK REPORT</h5>
                        <Container className="alertreport-container">
                            <CardContent>
                                <Form>
                                    <Row>
                                        <Col xs={10}>
                                            <Form.Group>
                                                <Row>
                                                    ...
                                                    <Col>
                                                        <Button variant="primary" className="btn-pepReport" style={{ marginTop: '15%' }} onClick={fetchAllName}>
                                                            All
                                                        </Button>
                                                    </Col>
                                                </Row>
