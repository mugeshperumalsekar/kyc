...
import { Box, Button, Card, Typography, Grid, FormControl, InputLabel, Select, MenuItem, Checkbox, FormControlLabel, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Dialog, DialogActions, DialogContent, DialogTitle, Alert, SelectChangeEvent } from '@mui/material';
import EditIcon from '@mui/icons-material/Edit';
import BlockIcon from '@mui/icons-material/Block';
import LevelMappingApiService from '../../../data/services/pep_search/levelMapping/levelmapping-api-service';
                    ...
                    {activeTab === 'insert' && (
                        <Box mt={4}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} sm={4}>
                                    <FormControl fullWidth variant="outlined">
                                        <InputLabel id="passing-level-select-label">Passing Level</InputLabel>
                                        <Select
                                ...
                                <Table size="small">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell style={{ padding: '6px', fontSize: '0.8rem' }}>Passing Level</TableCell>
                                            <TableCell style={{ padding: '6px', fontSize: '0.8rem' }}>Is Alive</TableCell>
