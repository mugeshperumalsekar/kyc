...
class LevelStatusMappingApiService {
    ...
    createLevelStatusMapping = async (payload: LevelStatusMappingPayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost('/api/v1/StatusMapping/CreateStatusMappingRequest', payload);
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelStatusMapping = async () => {
        try {
            const response = await this.httpClientWrapper.ALget('/api/v1/StatusMapping');
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelOneData = async (loginDetails: any) => {
        try {
            ...
            const response = await this.httpClientWrapper.ALget(`/api/v1/LevelOne/levelId?levelId=${levelId}`);
    ...
    updateLevelStatusMapping = async (levelId: any, statusId: any, payload: LevelStatusMappingPayload) => {
        try {
            ...
            const response = await this.httpClientWrapper.ALput(url, payload);
    ...
    getLevelStatus = async (levelId: any, statusId: any) => {
        try {
            const response = await this.httpClientWrapper.ALget(`/api/v1/StatusMapping/${levelId}/statusId?levelId=${levelId}&statusId=${statusId}`);
            return response;
        } catch (error) {
