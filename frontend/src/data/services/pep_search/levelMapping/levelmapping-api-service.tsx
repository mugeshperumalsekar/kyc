...
class LevelMappingApiService {
    ...
    CreateLevelMapping = async (payload: LevelMappingPayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost3('/api/v1/LevelMapping/CreateLevelMappingRequest', payload);
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelMapping = async () => {
        try {
            const response = await this.httpClientWrapper.ALget3('/api/v1/LevelMapping');
            return response;
        } catch (error) {
            throw error;
        }
