...
class LevelStatusMappingApiService {
    ...
    createLevelStatusMapping = async (payload: LevelStatusMappingPayload) => {
        try {
            const response = await this.httpClientWrapper.post('/api/v1/StatusMapping/CreateStatusMappingRequest', payload);
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelStatusMapping = async () => {
        try {
            const response = await this.httpClientWrapper.get('/api/v1/StatusMapping');
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelOneData = async (loginDetails: any) => {
        try {
          console.log("loginDetails:", loginDetails);  // Log to verify login details
    ...
    getLevelStatus = async (levelId: any, statusId: any) => {
        try {
            const response = await this.httpClientWrapper.get(`/api/v1/StatusMapping/${levelId}/statusId?levelId=${levelId}&statusId=${statusId}`);
            return response;
        } catch (error) {
