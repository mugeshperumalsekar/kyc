...
class LevelMappingApiService {
    ...
    CreateLevelMapping = async (payload: LevelMappingPayload) => {
        try {
            const response = await this.httpClientWrapper.post('/api/v1/LevelMapping/CreateLevelMappingRequest', payload);
            return response;
        } catch (error) {
            throw error;
        }
    ...
    getLevelMapping = async () => {
        try {
            const response = await this.httpClientWrapper.get('/api/v1/LevelMapping');
            return response;
        } catch (error) {
            throw error;
        }
    ...
    fetchLevelMappingById = async (id: number) => {
        try {
            const response = await this.httpClientWrapper.get(`/api/v1/LevelMapping/${id}`);
    ...
    updateLevelMapping = async (levelId: any, statusId: any, payload: LevelMappingPayload) => {
        try {
            ...
            const response = await this.httpClientWrapper.put(url, payload);
            return response.data; 
        } catch (error) {
    ...
    getLevelStatus = async (levelId: any, statusId: any) => {
        try {
            const response = await this.httpClientWrapper.get(`/api/v1/LevelMapping/${levelId}/statusId?levelId=${levelId}&statusId=${statusId}`);
            return response;
        } catch (error) {
